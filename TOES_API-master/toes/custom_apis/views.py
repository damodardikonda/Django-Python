...
def display_by_category(request,category):
    ...
    cursor.execute(f"select  name, phone, city, category_1, category_1_vc, category_1_exp, category_2, category_2_vc, category_2_exp,category_3,category_3_vc,category_3_exp  from authapp_user INNER JOIN authapp_worker_details ON authapp_user.id = authapp_worker_details.user_id where category_1 = '{category}' OR category_2 = '{category}' OR category_3 = '{category}'")
...
def display_all(request):
    ...
    cursor.execute('select  name, phone, city, category_1, category_1_vc, category_1_exp, category_2, category_2_vc, category_2_exp, category_3, category_3_vc, category_3_exp  from authapp_user INNER JOIN authapp_worker_details ON authapp_user.id = authapp_worker_details.user_id')
